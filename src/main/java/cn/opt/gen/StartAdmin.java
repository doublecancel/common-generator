...
public class StartAdmin {
    ...
    private static final String domainPackageName = "com.ucpaas.admin.domain.base";
    ...
    private static final String daoPackageName = "com.ucpaas.admin.dao.master";
    ...
    public static StartAdmin create(){
        return new StartAdmin();
    }
